        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h1 class="modal-title fs-5" id="staticBackdropLabel">Gestion de CUPS</h1>
...
import formclientes from '../../components/Sections/cups/formcups.vue';
