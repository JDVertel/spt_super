<template>
    <div class="container-fluid">
        <div class="card-body mt-3">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="staticBackdropLabel">Gestion de cliente</h1>
            ...
            <h4 class="mt-4"> IPS y Clinicas </h4>
                        ...
                        <tr v-for="(datatabla, index) in tabla" :key="index">
                            ...
                            <td>
                                <div class=" d-flex justify-content-center">
                                    ...
                                    <button class="btn btn_options2 btn-sm btn-light" title="Editar"
                                        data-bs-toggle="modal" data-bs-target="#staticBackdrop"
                                        @click="editar(datatabla)">
...
import formclientes from '../../components/Sections/clientes/formclientes.vue';
